...
We recommend to use a CDN instead.
WARNING
    end
  end
...
For supported Ruby versions see https://packages.#{ENV['DOMAIN']}/buildpack-ruby/ruby_versions.yml
Please contact support@cloudcontrol.com if you miss a version
#{error.message}
ERROR
    error message
  end
...
Detected sqlite3 gem which is not supported on cloudControl.
ERROR
          end
